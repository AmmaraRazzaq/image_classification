...
if __name__ == "__main__":
    ...
    parser.add_argument("--step_size",              type=int,   default=35,                      help="step size for stepLR")
    parser.add_argument('--model',                  type=str,   default='resnet101',                        help='resnet101, enetb6')
    parser.add_argument('--port',                   type=int,   default=5500,                      help='port for ddp training')
    parser.add_argument('--train_beton_path',       type=str,   default='dataset.beton',                      help='beton file path for training data')
